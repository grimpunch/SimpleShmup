...
public class PlayerShoot : MonoBehaviour
{
	...
	{
		if (player == 1) {
			return InputManager.Fire1_P1;
		} else {
			return InputManager.Fire1_P2; //Uncomment when implemented
		}
	}

	public bool FocusFireButtonDown()
	{
		if (player == 1) {
			return InputManager.Fire2_P1;
		} else {
			return InputManager.Fire2_P2; //Uncomment when implemented
		}
	}
}
